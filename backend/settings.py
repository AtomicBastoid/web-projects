...
SECRET_KEY = 'django-insecure--_remxx9oh@l%!nhaq^sku66uftg5b723@appk7*qn=@%th0tm'
...
# Email settings
"""
When deployed change EMAIL_BACKEND to 'django.core.mail.backends.smtp.EmailBackend'
and configure the SMTP settings accordingly. 
"""
